...
insert into `board` values(0,1,"처음 이용하는 고객님들을 위한","단지 좋은 정보들 가져가시면 됩니다.",default,default,default,default,'2022-12-31 13:27:00','2022-12-31 13:27:00',"notice");
insert into `board` values(0,1,"이벤트 당첨자 공지","이유광 고객님\r\n김지연 고객님\r\n박윤희 고객님\r\n박태성 고객님\r\n이상진 고객님\r\n이윤호 고객님\r\n\r\n당첨을 축하드립니다!!!",default,default,default,default,default,default,"notice");
-- insert into `board` values(0,1,"이벤트 당첨자 공지","이유광 고객님\r\n김지연 고객님\r\n박윤희 고객님\r\n박태성 고객님\r\n이상진 고객님\r\n이윤호 고객님\r\n\r\n당첨을 축하드립니다!!!",default,default,default,default,'2023-1-1 10:01:00','2023-1-1 10:01:00',"notice");
...
-- 자유게시판
-- 임의 자유게시판 데이터 입력
INSERT INTO `BOARD`(`USER_NO`,`TITLE`,`CONTENT`,`READCOUNT`,`TYPE`) VALUES(3,'제주 정말 좋아요','정말 아름다운 바다를 볼 수 있었어요!',100,'free');
INSERT INTO `BOARD`(`USER_NO`,`TITLE`,`CONTENT`,`READCOUNT`,`TYPE`) VALUES(2,'제주도 또오고 싶어요','푸르른 산을 마음껏 보고 왔습니다.',50,'free');
INSERT INTO `BOARD`(`USER_NO`,`TITLE`,`CONTENT`,`READCOUNT`,`TYPE`) VALUES(4,'푸른 해변이 이뻐요','유익한 시간이었습니다.',10,'free');
INSERT INTO `BOARD`(`USER_NO`,`TITLE`,`CONTENT`,`READCOUNT`,`TYPE`) VALUES(2,'제주도 따뜻하네요','떨어지는 폭포가 정말 시원했습니다.',77,'free');
INSERT INTO `BOARD`(`USER_NO`,`TITLE`,`CONTENT`,`READCOUNT`,`TYPE`) VALUES(4,'돌하르방 많이 봤어요','아름다운 경치를 감상했습니다.',8,'free');
INSERT INTO `BOARD`(`USER_NO`,`TITLE`,`CONTENT`,`READCOUNT`,`TYPE`) VALUES(2,'바람이 시원하네요','겨울의 한라산을 눈에 담을 수 있어 좋았어요!',41,'free');
INSERT INTO `BOARD`(`USER_NO`,`TITLE`,`CONTENT`,`READCOUNT`,`TYPE`) VALUES(3,'숲에서 힐링했어요','피톤치드 향을 맘껏 느꼈습니다!',63,'free');
INSERT INTO `BOARD`(`USER_NO`,`TITLE`,`CONTENT`,`READCOUNT`,`TYPE`) VALUES(3,'해산물이 싱싱하네요','꽃들이 정말 이뻐요. 사진 정말 많이 찍었어요~',34,'free');
INSERT INTO `BOARD`(`USER_NO`,`TITLE`,`CONTENT`,`READCOUNT`,`TYPE`) VALUES(4,'바다에 발담그니 좋아요','바다가 정말 이뻐요. 사진 정말 많이 찍었어요~',83,'free');
INSERT INTO `BOARD`(`USER_NO`,`TITLE`,`CONTENT`,`READCOUNT`,`TYPE`) VALUES(4,'걷는데 힐링이 되네요','힘든 시기였는데 힐링하고 갑니다!',17,'free');
INSERT INTO `BOARD`(`USER_NO`,`TITLE`,`CONTENT`,`READCOUNT`,`TYPE`) VALUES(2,'아름다운 경치를 봤어요','자유로이 걸으며 힐링하고 갑니다!',24,'free');
INSERT INTO `BOARD`(`USER_NO`,`TITLE`,`CONTENT`,`READCOUNT`,`TYPE`) VALUES(2,'해변을 걸으니 힐링받았어요','좋은 사진 건졌어요.',74,'free');
INSERT INTO `BOARD`(`USER_NO`,`TITLE`,`CONTENT`,`READCOUNT`,`TYPE`) VALUES(3,'시원하게 수영했네요','탁트인 바다를 보이 마음이 편해요.',27,'free');